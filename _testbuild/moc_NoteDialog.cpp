...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_NoteDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_NoteDialog_t qt_meta_stringdata_NoteDialog = {
    {
        QT_MOC_LITERAL(0, 10),  // "NoteDialog"
        QT_MOC_LITERAL(11, 13),  // "onSaveClicked"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 15),  // "onCancelClicked"
        QT_MOC_LITERAL(42, 14),  // "onClearClicked"
        QT_MOC_LITERAL(57, 13)   // "onTextChanged"
    },
    "NoteDialog",
    "onSaveClicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_NoteDialog[] = {
...
Q_CONSTINIT const QMetaObject NoteDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_NoteDialog.offsetsAndSizes,
    qt_meta_data_NoteDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_NoteDialog_t,
        // Q_OBJECT / Q_GADGET
